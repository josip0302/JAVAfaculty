...
public class Inicijalizacija implements ServletContextListener {
	...
	public void contextInitialized(ServletContextEvent sce) {
		...
		try {
			...
			if(!pollsopt){
				...
				if(!b){
					...
					list.add("1##The Beatles##https://www.youtube.com/watch?v=z9ypq6_5bsg##1##0##0");
					list.add("2##The Platters##https:  //www.youtube.com/watch?v=H2di83WAOhU##1##0##0");
					list.add("3##The Beach Boys##https://www.youtube.com/watch?v=2s4slliAtQU##1##0##0");
					list.add("4##The Four Seasons##https://www.youtube.com/watch?v=y8yvnqHmFds##1##0##0");
					list.add("5##The Marcels##https://www.youtube.com/watch?v=qoi3TH59ZEs##1##0##0");
					list.add("6##The Everly Brothers##https://www.youtube.com/watch?v=tbU3zdAgiX8##1##0##0");
					list.add("7##The Mamas And The Papas##https://www.youtube.com/watch?v=N-aK6JnyFmk##1##0##0");
					PreparedStatement pst=null;
					System.out.println("prazno polls");
					pst = con.prepareStatement(
							"INSERT INTO POOLOPTIONS ( OPTIONTITLE, OPTIONLINK,POLLID,LIKECOUNT,DISCOUNT) values (?,?,?,?,?)",
							Statement.RETURN_GENERATED_KEYS);
					for(String a:list) {
		...
		System.out.println("inicializirano");
