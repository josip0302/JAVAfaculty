...
private long modificationCount;
     ...
     */
    public ArrayIndexedCollection (Collection<T> collection) throws NullPointerException{
     ...
     * @throws IllegalArgumentException if initalcapacity is lower than 1
     */
    public ArrayIndexedCollection(Collection<T> collection,int initialCapacity) throws NullPointerException ,IllegalArgumentException {
    ...
    public void add(T value) throws NullPointerException{
        ...
        if(this.elements.length<this.size){
            ...
            T[] elem=this.elements.clone();
            elements=(T[]) new Object[x];
    ...
    private static class ArrayElementsGetter<T> implements ElementsGetter<T>{
        ...
        ArrayIndexedCollection<T> coll;
        public ArrayElementsGetter(ArrayIndexedCollection<T> coll){
            this.currentPosition=0;
            this.coll=coll;
            this.savedModificationCount=coll.modificationCount;
        }
        @Override
        public T getNextElement() throws  ConcurrentModificationException{
